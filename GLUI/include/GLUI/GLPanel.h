...
namespace glui {
	...
	private:
		...
		Vector2f m_fboSize;
	public:
		GLPanel(Rectangle bounds, Vector2f fboSize, Layout* layout, glpanel_init_gl_func initGLFunc, glpanel_render_func renderFunc, glpanel_input_mouse_func inputMouseFunc, Theme theme);
		void poll() override;
